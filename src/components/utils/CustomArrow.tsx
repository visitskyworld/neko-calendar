...
export const CustomLeftArrow = ({ onClick, className }: Props) => {
  return (
    <button
      ...
      className={`absolute outline-none rounded-full z-[1000] border-solid border-2 border-[#a04ef6] bg-[#fff]/[0.7] hover:bg-[#fff] w-min-[43px] h-min-[43px] cursor-pointer p-4 ${
